                    ...
                    <div className="swiper main-slide-carousel swiper-container relative mb-6">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <div className="block">
                                <img src={product?.attributes?.product_Image?.data[numImage]?.attributes?.url} alt='product-info' width={400} height={400} className="max-lg:mx-auto object-cover md:mx-auto w-[80%] h-[500px] rounded-lg"/>
                            </div>
                        </div>
                        </div>
                      </div>
                      <div className="nav-for-slider ">
                        <div className="swiper-wrapper grid grid-cols-4 gap-4">
                          <div onClick={() => setNumImage(0)} className="swiper-slide thumbs-slide mx-auto group">
                            <Image src={product?.attributes?.product_Image?.data[0]?.attributes?.url} alt='product-info' width={400} height={400}
                            className="cursor-pointer rounded-xl transition-all duration-500 border-2  group-hover:border-primary"/>
                          </div>
                          <div  onClick={() => setNumImage(1)} className="swiper-slide thumbs-slide mx-auto group">
                            <Image src={product?.attributes?.product_Image?.data[1]?.attributes?.url} alt='product-info' width={400} height={400}
                            className="cursor-pointer rounded-xl transition-all duration-500 border-2 group-hover:border-primary"/>
                          </div>
                          <div  onClick={() => setNumImage(2)} className="swiper-slide thumbs-slide mx-auto group">
                            <Image src={product?.attributes?.product_Image?.data[2]?.attributes?.url} alt='product-info' width={400} height={400}
                            className="cursor-pointer rounded-xl transition-all duration-500 border-2 group-hover:border-primary"/>
                          </div>
                          <div  onClick={() => setNumImage(3)} className="swiper-slide thumbs-slide mx-auto group">
                            <Image src={product?.attributes?.product_Image?.data[3]?.attributes?.url} alt='product-info' width={400} height={400}
                            className="cursor-pointer rounded-xl transition-all duration-500 border-2 group-hover:border-primary"/>
                          </div>
                      </div>
                      </div>
