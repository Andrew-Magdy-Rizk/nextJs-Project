...
export default function Page() {
  ...
  return (
    <div className={`relative overflow-hidden ${modeState && "dark bg-[#171717]"}`}>
  <div className="mx-auto max-w-screen-md py-12 px-4 sm:px-6 md:max-w-screen-xl md:py-20 lg:py-32 md:px-8">
    <div className="md:pe-8 md:w-1/2 xl:pe-0 xl:w-5/12">
      {/* <!-- Title --> */}
      <h1 className="text-3xl text-gray-800 dark:text-gray-200 font-bold md:text-4xl md:leading-tight lg:text-5xl lg:leading-tight">
